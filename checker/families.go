...
var allFamiliesList = []Family{
	...
	},
	{
		...
		Severity:    "error",
		Name:        "AWS",
		Description: "AWS-specific literals — region codes, 12-digit account IDs, ARN grammar (across the aws, aws-us-gov, aws-cn, aws-eusc, aws-iso, aws-iso-b, aws-iso-e, and aws-iso-f partitions). Provider-specific checks that catch AWS reference typos without requiring provider gRPC.",
	},
