...
func TestRun_Describe_ListsChecks(t *testing.T) {
	...
	for _, code := range []string{"E001", "E008", "W001", "W009", "E101", "E201", "E202", "E203", "E210"} {
...
func TestRun_DescribeJSON_ParsesAndContainsAllCodes(t *testing.T) {
	...
	for _, want := range []string{"E001", "E002", "E003", "E004", "E005", "E006", "E007", "E008", "E009", "W001", "W009", "E101", "E201", "E202", "E203", "E210"} {
		if !codes[want] {
